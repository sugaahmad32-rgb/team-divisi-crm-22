...
('gggggggg-gggg-gggg-gggg-gggggggggggg', 'Partner Channel', 'Leads from business partners')
ON CONFLICT (id) DO NOTHING;
...
('c7777777-7777-7777-7777-777777777777', 'Carlos Rodriguez', 'Restaurant Group', 'carlos@restaurantgroup.com', '+1234567896', '+1234567896', '555 Food Court, Miami', 'new', 'gggggggg-gggg-gggg-gggg-gggggggggggg', 'u5555555-5555-5555-5555-555555555555', NULL, 'u1111111-1111-1111-1111-111111111111', '44444444-4444-4444-4444-444444444444', 80000, 'Restaurant chain needs customer loyalty system', 'u5555555-5555-5555-5555-555555555555'),
